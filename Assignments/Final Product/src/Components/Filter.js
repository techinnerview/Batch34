...
class Filter extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            ...
            data: obj
        }).then(response => this.setState({ resturants: response.data, location, mealTypeId })).catch()
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8">
                            {resturants && resturants.length > 0 ? resturants.map(item => {
                                return <div class="FilterItems" onClick={() => this.handleNextPage(item._id)}>
                                    ...
                                    <div class="FilterFort">{item.address}</div>
                                    ...
                                    <div class="FilterBakery">{item.cuisine}</div>
